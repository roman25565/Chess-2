...
namespace Chess.UI
{
	public class BoardUI : MonoBehaviour
	{
		...
		public void UpdatePosition(Core.Board board, Move move, bool animate = false)
		{
			lastMadeMove = move;
			if (animate)
			{
		...
		public void UpdatePosition(Core.Board board)
		{
		...
		public void HighlightLegalMoves(Core.Board board, Coord fromSquare)
		{
			if (showLegalMoves)
			{
		...
		public void HighlightLastMadeMoveSquares(Core.Board board)
		{
		...
		IEnumerator AnimateMove(Move move, Core.Board board)
		{
			float t = 0;
