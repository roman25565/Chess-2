...
internal class CreateNewFieldInitMethodRewriter : FastScriptReloadCodeRewriterBase
{
    ...
    {
        return (Dictionary<string, Func<object>>)forType
            .GetField(NewFieldsToGetTypeFnDictionaryFieldName, BindingFlags.NonPublic | BindingFlags.Static)
            .GetValue(null);
    }
    ...
    public override SyntaxNode VisitClassDeclaration(ClassDeclarationSyntax node)
    {
        ...
        var withDictionaryFieldNameToInitFieldValue = CreateNewFieldNameToGetObjectFnDictionary(node, newClassFields,
            getObjectFnSyntax, NewFieldsToCreateValueFnDictionaryFieldName);
