            ...
            if (_isHistoryMatch)
            {
                _matchData = new MatchData//first player is always white in history
                {
                    ...
                    Player1 = new PlayerData
                    {
                        Arrangement = null,
                        FirebasePlayer = null,
                        IsRotate = historyMatchData.Player1Id != _settings.FirestoreManager.PlayerData.ID,
                        PlayerId = 1,
                        TimeToMove = -1,
                        IsMoving = true,
                        IsWhite = true,
                    ...
                    Player2 = new PlayerData
                    {
                        Arrangement = null,
                        FirebasePlayer = null,
                        IsRotate = historyMatchData.Player2Id != _settings.FirestoreManager.PlayerData.ID,
                        PlayerId = 2,
                        TimeToMove = -1,
                        IsMoving = false,
                        IsWhite = false,
                ...
                _settings.FirestoreManager.GetIcon(historyMatchData.Player1Id, (Sprite sprite) =>
                {
                    SetPlayerUI(new FirebasePlayerData(historyMatchData.Player1Id, historyMatchData.Player1Name,
                        historyMatchData.Player1Elo, sprite, null, null), historyMatchData.Player1Id != _settings.FirestoreManager.PlayerData.ID);
                });
                
                _settings.FirestoreManager.GetIcon(historyMatchData.Player2Id, (Sprite sprite) =>
                {
                    SetPlayerUI(new FirebasePlayerData(historyMatchData.Player2Id, historyMatchData.Player2Name,
                        historyMatchData.Player2Elo, sprite, null, null), historyMatchData.Player2Id != _settings.FirestoreManager.PlayerData.ID);
                });
